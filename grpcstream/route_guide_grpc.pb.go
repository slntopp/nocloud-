...
func (c *routeGuideClient) RouteChat(ctx context.Context, opts ...grpc.CallOption) (RouteGuide_RouteChatClient, error) {
	stream, err := c.cc.NewStream(ctx, &RouteGuide_ServiceDesc.Streams[0], "/grpcstream.RouteGuide/RouteChat", opts...)
	if err != nil {
		return nil, err
	}
...
var RouteGuide_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "grpcstream.RouteGuide",
	...
	Metadata: "grpcstream/route_guide.proto",
}
